...
####
PROJECT_NGHTTP2_WITH_DISABLED_TEST_APPS="${MY_PROJECT_NGHTTP2_WITH_DISABLED_TEST_APPS:=OFF}"
...
if [ "ON" = "$PROJECT_NGHTTP2_WITH_DISABLED_TEST_APPS" ]; then
    MY_CMAKE_COMMON_ARGUMENT_LIST+=("-DNGHTTP2_WITH_DISABLED_TEST_APPS=$PROJECT_NGHTTP2_WITH_DISABLED_TEST_APPS")
fi
...
echo "[$SYSTEM_PLATFORM] Component information: nghttp2 with disabled test apps: $PROJECT_NGHTTP2_WITH_DISABLED_TEST_APPS"
